...
// include: /var/folders/dc/42pmfb05707bp4jhyy7l6_xr0000gn/T/tmp76cs5t_9.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'NeuralNetDemo.data';
      var REMOTE_PACKAGE_BASE = 'NeuralNetDemo.data';
...
Module['FS_createPath']("/", "shaders", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_NeuralNetDemo.data');
      }
      Module['addRunDependency']('datafile_NeuralNetDemo.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/basic.frag", "start": 0, "end": 110}, {"filename": "/shaders/basic.vert", "start": 110, "end": 787}, {"filename": "/shaders/basic_es.frag", "start": 787, "end": 939}, {"filename": "/shaders/basic_es.vert", "start": 939, "end": 1658}, {"filename": "/shaders/field.frag", "start": 1658, "end": 3490}, {"filename": "/shaders/field.vert", "start": 3490, "end": 3632}, {"filename": "/shaders/field_es.frag", "start": 3632, "end": 5506}, {"filename": "/shaders/field_es.vert", "start": 5506, "end": 5690}, {"filename": "/shaders/grid.frag", "start": 5690, "end": 5800}, {"filename": "/shaders/grid.vert", "start": 5800, "end": 5910}, {"filename": "/shaders/grid_es.frag", "start": 5910, "end": 6062}, {"filename": "/shaders/grid_es.vert", "start": 6062, "end": 6214}, {"filename": "/shaders/point.frag", "start": 6214, "end": 6770}, {"filename": "/shaders/point.vert", "start": 6770, "end": 7076}, {"filename": "/shaders/point_es.frag", "start": 7076, "end": 7674}, {"filename": "/shaders/point_es.vert", "start": 7674, "end": 8022}], "remote_package_size": 8022});

  })();

// end include: /var/folders/dc/42pmfb05707bp4jhyy7l6_xr0000gn/T/tmp76cs5t_9.js
// include: /var/folders/dc/42pmfb05707bp4jhyy7l6_xr0000gn/T/tmprh_g2zah.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/dc/42pmfb05707bp4jhyy7l6_xr0000gn/T/tmprh_g2zah.js
// include: /var/folders/dc/42pmfb05707bp4jhyy7l6_xr0000gn/T/tmpkbgtesq2.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/dc/42pmfb05707bp4jhyy7l6_xr0000gn/T/tmpkbgtesq2.js
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('NeuralNetDemo.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('NeuralNetDemo.wasm', import.meta.url).href;
...
var _nn_shutdown = Module['_nn_shutdown'] = makeInvalidEarlyAccess('_nn_shutdown');
var _nn_set_point_size = Module['_nn_set_point_size'] = makeInvalidEarlyAccess('_nn_set_point_size');
var _nn_set_dataset = Module['_nn_set_dataset'] = makeInvalidEarlyAccess('_nn_set_dataset');
var _nn_set_auto_train = Module['_nn_set_auto_train'] = makeInvalidEarlyAccess('_nn_set_auto_train');
var _nn_step_train = Module['_nn_step_train'] = makeInvalidEarlyAccess('_nn_step_train');
var _nn_set_learning_rate = Module['_nn_set_learning_rate'] = makeInvalidEarlyAccess('_nn_set_learning_rate');
var _nn_set_batch_size = Module['_nn_set_batch_size'] = makeInvalidEarlyAccess('_nn_set_batch_size');
var _nn_set_auto_max_epochs = Module['_nn_set_auto_max_epochs'] = makeInvalidEarlyAccess('_nn_set_auto_max_epochs');
var _nn_set_auto_target_loss = Module['_nn_set_auto_target_loss'] = makeInvalidEarlyAccess('_nn_set_auto_target_loss');
var _nn_set_use_target_loss_stop = Module['_nn_set_use_target_loss_stop'] = makeInvalidEarlyAccess('_nn_set_use_target_loss_stop');
var _nn_set_optimizer = Module['_nn_set_optimizer'] = makeInvalidEarlyAccess('_nn_set_optimizer');
var _nn_set_momentum = Module['_nn_set_momentum'] = makeInvalidEarlyAccess('_nn_set_momentum');
var _nn_set_adam_beta1 = Module['_nn_set_adam_beta1'] = makeInvalidEarlyAccess('_nn_set_adam_beta1');
var _nn_set_adam_beta2 = Module['_nn_set_adam_beta2'] = makeInvalidEarlyAccess('_nn_set_adam_beta2');
var _nn_set_adam_eps = Module['_nn_set_adam_eps'] = makeInvalidEarlyAccess('_nn_set_adam_eps');
var _nn_set_init_mode = Module['_nn_set_init_mode'] = makeInvalidEarlyAccess('_nn_set_init_mode');
var _nn_set_probe_enabled = Module['_nn_set_probe_enabled'] = makeInvalidEarlyAccess('_nn_set_probe_enabled');
var _nn_set_probe_position = Module['_nn_set_probe_position'] = makeInvalidEarlyAccess('_nn_set_probe_position');
var _nn_get_last_loss = Module['_nn_get_last_loss'] = makeInvalidEarlyAccess('_nn_get_last_loss');
var _nn_get_last_accuracy = Module['_nn_get_last_accuracy'] = makeInvalidEarlyAccess('_nn_get_last_accuracy');
var _nn_get_step_count = Module['_nn_get_step_count'] = makeInvalidEarlyAccess('_nn_get_step_count');
var _nn_get_learning_rate = Module['_nn_get_learning_rate'] = makeInvalidEarlyAccess('_nn_get_learning_rate');
var _nn_get_batch_size = Module['_nn_get_batch_size'] = makeInvalidEarlyAccess('_nn_get_batch_size');
var _nn_get_auto_train = Module['_nn_get_auto_train'] = makeInvalidEarlyAccess('_nn_get_auto_train');
var _nn_get_dataset_index = Module['_nn_get_dataset_index'] = makeInvalidEarlyAccess('_nn_get_dataset_index');
var _nn_get_num_points = Module['_nn_get_num_points'] = makeInvalidEarlyAccess('_nn_get_num_points');
var _nn_get_spread = Module['_nn_get_spread'] = makeInvalidEarlyAccess('_nn_get_spread');
var _nn_get_point_size = Module['_nn_get_point_size'] = makeInvalidEarlyAccess('_nn_get_point_size');
var _nn_get_auto_max_epochs = Module['_nn_get_auto_max_epochs'] = makeInvalidEarlyAccess('_nn_get_auto_max_epochs');
var _nn_get_auto_target_loss = Module['_nn_get_auto_target_loss'] = makeInvalidEarlyAccess('_nn_get_auto_target_loss');
var _nn_get_use_target_loss_stop = Module['_nn_get_use_target_loss_stop'] = makeInvalidEarlyAccess('_nn_get_use_target_loss_stop');
var _nn_get_optimizer = Module['_nn_get_optimizer'] = makeInvalidEarlyAccess('_nn_get_optimizer');
var _nn_get_momentum = Module['_nn_get_momentum'] = makeInvalidEarlyAccess('_nn_get_momentum');
var _nn_get_adam_beta1 = Module['_nn_get_adam_beta1'] = makeInvalidEarlyAccess('_nn_get_adam_beta1');
var _nn_get_adam_beta2 = Module['_nn_get_adam_beta2'] = makeInvalidEarlyAccess('_nn_get_adam_beta2');
var _nn_get_adam_eps = Module['_nn_get_adam_eps'] = makeInvalidEarlyAccess('_nn_get_adam_eps');
var _nn_get_init_mode = Module['_nn_get_init_mode'] = makeInvalidEarlyAccess('_nn_get_init_mode');
var _nn_get_probe_enabled = Module['_nn_get_probe_enabled'] = makeInvalidEarlyAccess('_nn_get_probe_enabled');
var _nn_get_probe_x = Module['_nn_get_probe_x'] = makeInvalidEarlyAccess('_nn_get_probe_x');
var _nn_get_probe_y = Module['_nn_get_probe_y'] = makeInvalidEarlyAccess('_nn_get_probe_y');
var _nn_get_selected_point_index = Module['_nn_get_selected_point_index'] = makeInvalidEarlyAccess('_nn_get_selected_point_index');
var _nn_get_selected_label = Module['_nn_get_selected_label'] = makeInvalidEarlyAccess('_nn_get_selected_label');
var _nn_get_max_points = Module['_nn_get_max_points'] = makeInvalidEarlyAccess('_nn_get_max_points');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['nn_shutdown'] != 'undefined', 'missing Wasm export: nn_shutdown');
  assert(typeof wasmExports['nn_set_point_size'] != 'undefined', 'missing Wasm export: nn_set_point_size');
  assert(typeof wasmExports['nn_set_dataset'] != 'undefined', 'missing Wasm export: nn_set_dataset');
  assert(typeof wasmExports['nn_set_auto_train'] != 'undefined', 'missing Wasm export: nn_set_auto_train');
  assert(typeof wasmExports['nn_step_train'] != 'undefined', 'missing Wasm export: nn_step_train');
  assert(typeof wasmExports['nn_set_learning_rate'] != 'undefined', 'missing Wasm export: nn_set_learning_rate');
  assert(typeof wasmExports['nn_set_batch_size'] != 'undefined', 'missing Wasm export: nn_set_batch_size');
  assert(typeof wasmExports['nn_set_auto_max_epochs'] != 'undefined', 'missing Wasm export: nn_set_auto_max_epochs');
  assert(typeof wasmExports['nn_set_auto_target_loss'] != 'undefined', 'missing Wasm export: nn_set_auto_target_loss');
  assert(typeof wasmExports['nn_set_use_target_loss_stop'] != 'undefined', 'missing Wasm export: nn_set_use_target_loss_stop');
  assert(typeof wasmExports['nn_set_optimizer'] != 'undefined', 'missing Wasm export: nn_set_optimizer');
  assert(typeof wasmExports['nn_set_momentum'] != 'undefined', 'missing Wasm export: nn_set_momentum');
  assert(typeof wasmExports['nn_set_adam_beta1'] != 'undefined', 'missing Wasm export: nn_set_adam_beta1');
  assert(typeof wasmExports['nn_set_adam_beta2'] != 'undefined', 'missing Wasm export: nn_set_adam_beta2');
  assert(typeof wasmExports['nn_set_adam_eps'] != 'undefined', 'missing Wasm export: nn_set_adam_eps');
  assert(typeof wasmExports['nn_set_init_mode'] != 'undefined', 'missing Wasm export: nn_set_init_mode');
  assert(typeof wasmExports['nn_set_probe_enabled'] != 'undefined', 'missing Wasm export: nn_set_probe_enabled');
  assert(typeof wasmExports['nn_set_probe_position'] != 'undefined', 'missing Wasm export: nn_set_probe_position');
  assert(typeof wasmExports['nn_get_last_loss'] != 'undefined', 'missing Wasm export: nn_get_last_loss');
  assert(typeof wasmExports['nn_get_last_accuracy'] != 'undefined', 'missing Wasm export: nn_get_last_accuracy');
  assert(typeof wasmExports['nn_get_step_count'] != 'undefined', 'missing Wasm export: nn_get_step_count');
  assert(typeof wasmExports['nn_get_learning_rate'] != 'undefined', 'missing Wasm export: nn_get_learning_rate');
  assert(typeof wasmExports['nn_get_batch_size'] != 'undefined', 'missing Wasm export: nn_get_batch_size');
  assert(typeof wasmExports['nn_get_auto_train'] != 'undefined', 'missing Wasm export: nn_get_auto_train');
  assert(typeof wasmExports['nn_get_dataset_index'] != 'undefined', 'missing Wasm export: nn_get_dataset_index');
  assert(typeof wasmExports['nn_get_num_points'] != 'undefined', 'missing Wasm export: nn_get_num_points');
  assert(typeof wasmExports['nn_get_spread'] != 'undefined', 'missing Wasm export: nn_get_spread');
  assert(typeof wasmExports['nn_get_point_size'] != 'undefined', 'missing Wasm export: nn_get_point_size');
  assert(typeof wasmExports['nn_get_auto_max_epochs'] != 'undefined', 'missing Wasm export: nn_get_auto_max_epochs');
  assert(typeof wasmExports['nn_get_auto_target_loss'] != 'undefined', 'missing Wasm export: nn_get_auto_target_loss');
  assert(typeof wasmExports['nn_get_use_target_loss_stop'] != 'undefined', 'missing Wasm export: nn_get_use_target_loss_stop');
  assert(typeof wasmExports['nn_get_optimizer'] != 'undefined', 'missing Wasm export: nn_get_optimizer');
  assert(typeof wasmExports['nn_get_momentum'] != 'undefined', 'missing Wasm export: nn_get_momentum');
  assert(typeof wasmExports['nn_get_adam_beta1'] != 'undefined', 'missing Wasm export: nn_get_adam_beta1');
  assert(typeof wasmExports['nn_get_adam_beta2'] != 'undefined', 'missing Wasm export: nn_get_adam_beta2');
  assert(typeof wasmExports['nn_get_adam_eps'] != 'undefined', 'missing Wasm export: nn_get_adam_eps');
  assert(typeof wasmExports['nn_get_init_mode'] != 'undefined', 'missing Wasm export: nn_get_init_mode');
  assert(typeof wasmExports['nn_get_probe_enabled'] != 'undefined', 'missing Wasm export: nn_get_probe_enabled');
  assert(typeof wasmExports['nn_get_probe_x'] != 'undefined', 'missing Wasm export: nn_get_probe_x');
  assert(typeof wasmExports['nn_get_probe_y'] != 'undefined', 'missing Wasm export: nn_get_probe_y');
  assert(typeof wasmExports['nn_get_selected_point_index'] != 'undefined', 'missing Wasm export: nn_get_selected_point_index');
  assert(typeof wasmExports['nn_get_selected_label'] != 'undefined', 'missing Wasm export: nn_get_selected_label');
  assert(typeof wasmExports['nn_get_max_points'] != 'undefined', 'missing Wasm export: nn_get_max_points');
  ...
  _nn_shutdown = Module['_nn_shutdown'] = createExportWrapper('nn_shutdown', 0);
  _nn_set_point_size = Module['_nn_set_point_size'] = createExportWrapper('nn_set_point_size', 1);
  _nn_set_dataset = Module['_nn_set_dataset'] = createExportWrapper('nn_set_dataset', 3);
  _nn_set_auto_train = Module['_nn_set_auto_train'] = createExportWrapper('nn_set_auto_train', 1);
  _nn_step_train = Module['_nn_step_train'] = createExportWrapper('nn_step_train', 0);
  _nn_set_learning_rate = Module['_nn_set_learning_rate'] = createExportWrapper('nn_set_learning_rate', 1);
  _nn_set_batch_size = Module['_nn_set_batch_size'] = createExportWrapper('nn_set_batch_size', 1);
  _nn_set_auto_max_epochs = Module['_nn_set_auto_max_epochs'] = createExportWrapper('nn_set_auto_max_epochs', 1);
  _nn_set_auto_target_loss = Module['_nn_set_auto_target_loss'] = createExportWrapper('nn_set_auto_target_loss', 1);
  _nn_set_use_target_loss_stop = Module['_nn_set_use_target_loss_stop'] = createExportWrapper('nn_set_use_target_loss_stop', 1);
  _nn_set_optimizer = Module['_nn_set_optimizer'] = createExportWrapper('nn_set_optimizer', 1);
  _nn_set_momentum = Module['_nn_set_momentum'] = createExportWrapper('nn_set_momentum', 1);
  _nn_set_adam_beta1 = Module['_nn_set_adam_beta1'] = createExportWrapper('nn_set_adam_beta1', 1);
  _nn_set_adam_beta2 = Module['_nn_set_adam_beta2'] = createExportWrapper('nn_set_adam_beta2', 1);
  _nn_set_adam_eps = Module['_nn_set_adam_eps'] = createExportWrapper('nn_set_adam_eps', 1);
  _nn_set_init_mode = Module['_nn_set_init_mode'] = createExportWrapper('nn_set_init_mode', 1);
  _nn_set_probe_enabled = Module['_nn_set_probe_enabled'] = createExportWrapper('nn_set_probe_enabled', 1);
  _nn_set_probe_position = Module['_nn_set_probe_position'] = createExportWrapper('nn_set_probe_position', 2);
  _nn_get_last_loss = Module['_nn_get_last_loss'] = createExportWrapper('nn_get_last_loss', 0);
  _nn_get_last_accuracy = Module['_nn_get_last_accuracy'] = createExportWrapper('nn_get_last_accuracy', 0);
  _nn_get_step_count = Module['_nn_get_step_count'] = createExportWrapper('nn_get_step_count', 0);
  _nn_get_learning_rate = Module['_nn_get_learning_rate'] = createExportWrapper('nn_get_learning_rate', 0);
  _nn_get_batch_size = Module['_nn_get_batch_size'] = createExportWrapper('nn_get_batch_size', 0);
  _nn_get_auto_train = Module['_nn_get_auto_train'] = createExportWrapper('nn_get_auto_train', 0);
  _nn_get_dataset_index = Module['_nn_get_dataset_index'] = createExportWrapper('nn_get_dataset_index', 0);
  _nn_get_num_points = Module['_nn_get_num_points'] = createExportWrapper('nn_get_num_points', 0);
  _nn_get_spread = Module['_nn_get_spread'] = createExportWrapper('nn_get_spread', 0);
  _nn_get_point_size = Module['_nn_get_point_size'] = createExportWrapper('nn_get_point_size', 0);
  _nn_get_auto_max_epochs = Module['_nn_get_auto_max_epochs'] = createExportWrapper('nn_get_auto_max_epochs', 0);
  _nn_get_auto_target_loss = Module['_nn_get_auto_target_loss'] = createExportWrapper('nn_get_auto_target_loss', 0);
  _nn_get_use_target_loss_stop = Module['_nn_get_use_target_loss_stop'] = createExportWrapper('nn_get_use_target_loss_stop', 0);
  _nn_get_optimizer = Module['_nn_get_optimizer'] = createExportWrapper('nn_get_optimizer', 0);
  _nn_get_momentum = Module['_nn_get_momentum'] = createExportWrapper('nn_get_momentum', 0);
  _nn_get_adam_beta1 = Module['_nn_get_adam_beta1'] = createExportWrapper('nn_get_adam_beta1', 0);
  _nn_get_adam_beta2 = Module['_nn_get_adam_beta2'] = createExportWrapper('nn_get_adam_beta2', 0);
  _nn_get_adam_eps = Module['_nn_get_adam_eps'] = createExportWrapper('nn_get_adam_eps', 0);
  _nn_get_init_mode = Module['_nn_get_init_mode'] = createExportWrapper('nn_get_init_mode', 0);
  _nn_get_probe_enabled = Module['_nn_get_probe_enabled'] = createExportWrapper('nn_get_probe_enabled', 0);
  _nn_get_probe_x = Module['_nn_get_probe_x'] = createExportWrapper('nn_get_probe_x', 0);
  _nn_get_probe_y = Module['_nn_get_probe_y'] = createExportWrapper('nn_get_probe_y', 0);
  _nn_get_selected_point_index = Module['_nn_get_selected_point_index'] = createExportWrapper('nn_get_selected_point_index', 0);
  _nn_get_selected_label = Module['_nn_get_selected_label'] = createExportWrapper('nn_get_selected_label', 0);
  _nn_get_max_points = Module['_nn_get_max_points'] = createExportWrapper('nn_get_max_points', 0);
